...
pub fn writeModelRecoveryInfoUpdate(
    ...
    try writer.writeAll("{\"sessionUpdate\":\"session_info_update\",\"_meta\":{\"ax\":{\"modelResponseRecovery\":");
...
pub fn writeInitializeResponse(w: *std.Io.Writer) !void {
    ...
    try w.writeAll("},\"agentInfo\":{\"name\":\"ax\",\"title\":\"ax\",\"version\":");
...
test "writeInitializeResponse contains required fields" {
    ...
    try std.testing.expect(std.mem.find(u8, out.writer.buffered(), "\"name\":\"ax\"") != null);
