...
const review_policy_template =
    \\<permission_review>
    \\  <role>
    \\    You are ax's last-chance safety reviewer for one pending coding-agent action.
...
test "automatic review policy matches the tested XML v1 artifact" {
    const expected_digest = [_]u8{
        0x93, 0x25, 0x67, 0x4c, 0x7f, 0x73, 0xbf, 0x08,
        0x3e, 0x4c, 0xc7, 0xa2, 0xad, 0xeb, 0xb5, 0x94,
        0xde, 0x0e, 0xb7, 0xc5, 0x22, 0xa2, 0x3d, 0x02,
        0xd2, 0x2b, 0x63, 0x8b, 0x8e, 0x5b, 0xe8, 0x84,
    };
