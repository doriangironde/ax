...
test "built-in model-facing tool contract stays byte exact" {
    ...
    try std.testing.expectEqualStrings(
        "9994a29b08b317706b6a574a2fb525284135d932d33046f0272212982b0fdf4e",
        &actual_hex,
    );
}
