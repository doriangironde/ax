...
const fetch = async (_url, init = {}) => {
  ...
  if (prompt.includes("unsupported web request")) {
    return textResponse("This embedded browser cannot access the public web. Install ax locally for the full tool suite.");
  }
